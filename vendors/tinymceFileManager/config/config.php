<?php
	@session_start();
	//bu iki değeri güvenlik amacıyla ben ekledim
	if(!$_SESSION[md5($_SESSION['key'])]['ADMIN']==1) exit ('...');
...
$config = array(
	...
	*/
	...
	|
	*/
	'upload_dir' => '/assets/uploads/images/manuel/'.date('Y/m/d').'/',
	...
	|
	*/
	'current_path' => '../../assets/uploads/images/manuel/'.date('Y/m/d').'/',
	...
	|
	*/
	'thumbs_base_path' => '../../assets/uploads_thumbs/images/manuel/'.date('Y/m/d').'/',
	...
	*/
	...
	// If you set a maximum width or height, oversized images are converted to those limits. 
	// Images smaller than the limit(s) are unaffected
	// if you don't need a limit set both to 0
	'image_max_width'                         => 600,
	'image_max_height'                        => 999,
	'image_max_mode'                          => 'auto',
	/*
	...
	//Automatic resizing //
	// If you set $image_resizing to TRUE the script converts all uploaded images exactly to 
	// image_resizing_width x image_resizing_height dimension
	// If you set width or height to 0 the script automatically calculates the other dimension
	// Is possible that if you upload very big images the script not work to overcome 
	// this increase the php configuration of memory and time limit
	'image_resizing'                          => false,
	'image_resizing_width'                    => 600,
	'image_resizing_height'                   => 999,
